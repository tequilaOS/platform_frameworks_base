...
import com.android.internal.util.tequila.ColorUtils;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.tequila.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.tequila.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
